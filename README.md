...
Install Pioneer Production Planner through Satisfactory Mod Manager.

Load a save and complete the Factory Planner Terminal milestone in HUB Tier 1.

Build the floor-standing terminal for 10 Iron Plates and 20 Cable.

Interact with it using the normal Use key.

Choose target-based planning or enable Plan from available inputs, configure your products and calculate.
...
Vanilla recipes and standard miners
...
KAPI / KLib Modular Miner integration

Optional

Multiplayer / dedicated servers

Matching planner version required on clients and server
