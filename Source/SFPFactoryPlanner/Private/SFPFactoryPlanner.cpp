...
void FSFPFactoryPlannerModule::StartupModule()
{
	if (IsRunningDedicatedServer())
	{
		UE_LOG(
			...
			Display,
			TEXT("Pioneer Production Planner 1.5.2 loaded on dedicated server; client-only Slate input disabled"));
		return;
	}
	...
	UE_LOG(
		LogSFPFactoryPlanner,
		Display,
		TEXT("Pioneer Production Planner 1.5.2 loaded; hotkey: %s"),
